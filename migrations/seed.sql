...
-- Users
-- Password: superadmin123 / admin123 / cs123
...
VALUES
    ...
    ('00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'cs@default.com', '$2b$10$/bajsbysXhG8H3Cx2bk5q.1rutQ0fhZrJfelzKM2Xqeb.evkNiufe', 'CS Default', 'cs', true, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
...
-- Conversations
INSERT INTO conversations (id, company_id, contact_id, assigned_agent_id, status, phone_number, last_message_preview, is_24h_window_active, unread_count, started_at, created_at, updated_at)
VALUES
    ('55555555-5555-5555-5555-555555555555', '00000000-0000-0000-0000-000000000001', '33333333-3333-3333-3333-333333333333', NULL, 'open', '6282131955087', 'Halo, ada yang bisa dibantu?', true, 1, NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day', NOW()),
    ('66666666-6666-6666-6666-666666666666', '00000000-0000-0000-0000-000000000001', '44444444-4444-4444-4444-444444444444', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'assigned', '6282131955087', 'Saya ingin menanyakan status pesanan', true, 0, NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days', NOW()),
    ('77777777-7777-7777-7777-777777777777', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', NULL, 'open', '6281234567890', 'Test message from Test Company', false, 3, NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days', NOW())
ON CONFLICT (id) DO NOTHING;
